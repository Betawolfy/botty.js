...
module.exports = {
	commandDescription: "3 - 4 partenariat avec la mention here",
	async execute(message, args) {
		...
		logger.info(`Service partenariat - un partenariat avec la mention here à été réalisé par ${message.author.username}`);
    partlogger.info(`Service partenariat - un partenariat avec la mention here à été réalisé par ${message.author.username} sur le serveur ${message.guild.name} (hiroshi) `);
...
const partEmbed = new Discord.MessageEmbed()
      ...
      +`꒷꒦₊˚✧Mention :<:coeurblanc:997161829996441630>  here. ꒷꒦₊˚\n`
