...
module.exports = {
	commandDescription: "4 - 4 partenariat sans mention",
	async execute(message, args) {
		...
		logger.info(`Service partenariat - un partenariat sans mention à été réalisé par ${message.author.username}`);
    partlogger.info(`Service partenariat - un partenariat sans mention à été réalisé par ${message.author.username} sur le serveur ${message.guild.name} (hiroshi) `);
...
const partEmbed = new Discord.MessageEmbed()
      ...
      +`꒷꒦₊˚✧Mention :<:coeurblanc:997161829996441630>  aucune. ꒷꒦₊˚\n`
