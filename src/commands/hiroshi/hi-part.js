...
module.exports = {
	commandDescription: "1 - 4 partenariat avec la mention partenariat",
    ...
    partlogger.info(`Service partenariat - un partenariat avec la mention partenariat à été réalisé par ${message.author.username} sur le serveur ${message.guild.name} (hiroshi) `);
...
const partEmbed = new Discord.MessageEmbed()
      ...
      +`꒷꒦₊˚✧Mention :<:coeurblanc:997161829996441630>  Partenariat. ꒷꒦₊˚\n`
	...
	.setFooter("Vous voulez que je fasse le même message sur votre serveur? allez voir wolfy en mp.");
		...
		message.channel.send("<@&997154866310955058>");
